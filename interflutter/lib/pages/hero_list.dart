              ...
              child: ListView(
                children: [
                  HeroCard(
                    name: 'Grace Hopper',
                    born:
                        "${AppLocalizations.of(context)!.bornText} ${DateFormat.yMMMMd(Localizations.localeOf(context).toString()).format(DateTime.tryParse(AppLocalizations.of(context)!.bornHero1)!)}",
